<?php
    ...
    if (isset($_GET['id'])){
        ...
        $rows = $result[0];
        $sql_problem = "SELECT * FROM contest_problem WHERE contest_id = '$id'";
        $result_problem = pdo_query($sql_problem);
    }else{
        echo "无此竞赛";
        exit;
    }
...
<head>
    ...
    <title>修改竞赛&实验 - AQNUOJ后台系统</title>
                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                <li><a href="#"></a>竞赛&实验管理</li>
                                <li class="active">修改竞赛&实验</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section id="main-content">
                <div class="card alert">
                    <div class="card-body">
                        ...
                        <form id="editContest-form" method="POST" action="">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input name="title" type="text" class="form-control border-none input-flat bg-ash" placeholder="" value="<?php echo $rows['title'];?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <select name="cat" type="text" class="form-control border-none input-flat bg-ash" placeholder="">
                                                <?php
                                                    if ($rows['cat'] == 0){?>
                                                        <option value="0" selected>竞赛</option>
                                ...
                                <div class="col-md-4">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <label>开始时间</label>
                                            <input name="start_time" type="text" class="form-control calendar bg-ash" placeholder="" id="start_time_picker" value="<?php echo $rows['start_time'];?>">
                                ...
                                <div class="col-md-4">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <label>结束时间</label>
                                            <input name="end_time" type="text" class="form-control bg-ash" placeholder="" id="end_time_picker" value="<?php echo $rows['end_time'];?>">
                                            <span class="ti-calendar form-control-feedback booking-system-feedback m-t-30"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <label>竞赛描述</label>
                                            <textarea rows="6" name="description" type="text" class="form-control border-none input-flat bg-ash" placeholder=""><?php echo $rows['description'];?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            <label>竞赛&实验包含的题目编号（用英文逗号隔开）</label>
                                            <textarea rows="6" name="cproblem" type="text" class="form-control border-none input-flat bg-ash" placeholder="例如：1000,1001"><?php
                                                foreach ($result_problem as $rp){
                                                    echo $rp['problem_id'].",";
                                                }
                                                ?></textarea>
                                        </div>
...
<script>
    ...
    $("#editContest-form").submit(function(){
        Base.post("/admin/tool/editContest.php", $('#editContest-form').serialize(),
            function (res) {
                if (res && res.code == 1) {
