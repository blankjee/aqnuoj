...
function import_fps($tempfile){
    global $OJ_DATA,$OJ_SAE,$OJ_REDIS,$OJ_REDISSERVER,$OJ_REDISPORT,$OJ_REDISQNAME,$OJ_NAME;
...
//		$test_output = getValue ( $searchNode, 'test_output' );
        ...
        if(!hasProblem($title )){
            ...
            echo "<br><span class=red>$title 已经在系统中了！</span>";
        }
...
if ($_FILES ["fps"] ["error"] > 0) {
    echo "Error Code: " . $_FILES ["fps"] ["error"] . "<br/>文件太大了！<br />";
} else {
